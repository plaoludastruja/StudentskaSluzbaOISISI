...
//		studenti.add(sandra);
		...
		Address l5 = new Address("Nikole Pašiæa","2d","Kikinda","Srbija");
		Address l6 = new Address("Bulevar Kralja Petra","22","Niš","Srbija");
		Address l7 = new Address("Tolstojeva","31","Novi Sad","Srbija");
		Address l8 = new Address("Mariæeva","11","Kragujevac","Srbija");
		Address l9 = new Address("Stražilovska","3","Beograd","Srbija");
		Address l10 = new Address("Nikole Pašiæa","6a","Novi Sad","Srbija");
		...
		studenti.add(new Student(1,"RA 2/2020",  "Marko","Milosevic",1,	LocalDate.parse("12.03.2001.",formatter),	l1	  , "021/333-555","marko.milosevic@mailinator.com",Status.B,	2020,new ArrayList<Grade>(),new ArrayList<Subject>()));
		studenti.add(new Student(2,"RA 3/2019",  "Marija","Miliæ",2,	LocalDate.parse("12.01.2000.",formatter),	l2	  , "021/555-2222","marija.milic@mailinator.com",Status.S,	2019,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(3,"RA 3/2017" , "Nikola","Nikolic",1,	LocalDate.parse("30.08.2001.",formatter),	l3	  , "021/135-463","nikola.nikolic@mailinator.com",Status.B,	2017,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(4,"RA 134/2015",	  "Pera","Peric",3,	LocalDate.parse("07.06.1995.",formatter),	l4	  , " 021/903-463","pera.peric@mailinator.com",Status.S,	2015,new ArrayList<Grade>(),student4));	
		studenti.add(new Student(5,"RA 5/2019",  "Sofija","Ilic",3,	LocalDate.parse("06.05.1999.",formatter),	l5	  , " 021/731-067","sofija.ilic@mailinator.com",Status.B,	2019,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(6,"RA 8/2018",	  "Martina","Lukic",3,	LocalDate.parse("16.05.1999.",formatter),	l6	  , "011/4333-800","martina.lukic@mailinator.com",Status.S,	2018,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(7,"RA 10/2017",	  "Stojan","Stojakovic",1,	LocalDate.parse("19.10.2001.",formatter),	l7	  , "011/3130-007","stojan.stojakovic@mailinator.com",Status.B,	2017,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(8,"RA 12/2017", 	  "Milan","Milanovic",2,	LocalDate.parse("02.11.2000.",formatter),	l8	  , "015/313-061","milan.milanovic@mailinator.com",Status.S,	2017,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(9,"RA 16/2019",	  "Miroslav","Milic",2,	LocalDate.parse("11.10.2000.",formatter),	l9	  , "021/351-091","miroslav.milic@mailinator.com",Status.B,	2019,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(10,"RA 21/2015",	  "Stefan","Gojic",3,	LocalDate.parse("01.05.1999.",formatter),	l10	 , "015/324-500","stefan.gojic@mailinator.com",Status.S,	2015,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(11,"RA 9/2020",  "Anastasija","Jokic",3,	LocalDate.parse("11.07.1999.",formatter),	l11	 , "011/2333-900","anastasija.jokic@mailinator.com",Status.B,	2020,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(12,"RA 4/2017" , "Bogdan","Bogdanovic",3,	LocalDate.parse("23.07.1999.",formatter),	l12	 , "021/231-231","bogdan.bogdanovic@mailinator.com",Status.S,	2017,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(13,"RA 30/2019",	  "Ana","Dabovic",1,	LocalDate.parse("12.12.2001.",formatter),	null,	"014/303-007","ana.dabovic@mailinator.com",Status.B,	2019,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(14,"RA 1/2020",  "Mika","Mikic",1,	LocalDate.parse("05.11.2001.",formatter),	l2	  , "015/101-909","mika.mikic@mailinator.com",Status.S,	2020,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(15,"RA 11/2018",	  "Jovan","Deretic",4,	LocalDate.parse("10.09.1998.",formatter),	l3	  , "002/200-300","jovan.deretic@mailinator.com",Status.B,	2018,new ArrayList<Grade>(), new ArrayList<Subject>()));	
		studenti.add(new Student(16,"RA 12/2018",	  "Nikola","Miskovic",4,	LocalDate.parse("03.08.1998.",formatter),	l4	  , "022/123-456","nikola.miskovic@mailinator.com",Status.S,	2018,new ArrayList<Grade>(), new ArrayList<Subject>()));	
		studenti.add(new Student(17,"RA 13/2018",	  "Martin","Stojanovic",4,	LocalDate.parse("01.05.1998.",formatter),	null,	"024/321-775","martin.stojanovic@mailinator.com",Status.S,	2018,new ArrayList<Grade>(),student17));	
		studenti.add(new Student(18,"RA 14/2018",    "Tomislav","Novakovic",4,	LocalDate.parse("25.02.1996.",formatter),	l6	  , "011/1188-379","tomislav.novakovic@mailinator.com",Status.B,	2018,new ArrayList<Grade>(),student18));	
		studenti.add(new Student(19,"RA 154/2016",	  "Lena","Ivic",4,	LocalDate.parse("11.05.1998.",formatter),	l7	  , "024/333-555","lena.ivic@mailinator.com",Status.B,	2016,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(20,"RA 23/2020"	, "Jovan","Lazic",1,	LocalDate.parse("22.01.2001.",formatter),	l8	  , "025/1189-479","jovan.lazic@mailinator.com",Status.B,	2020,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(21,"RA 1/2019" , "Isidora","Mikic",2,	LocalDate.parse("31.12.2000.",formatter),	l9	  , "011/1122-366","isidora.mikic@mailinator.com ",Status.B,	2019,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(22,"SW 4/2014" , "Vladimir","Ilic",4,	LocalDate.parse("31.08.1998.",formatter),	l10	 , "0211122-367","vladimir.ilic@mailinator.com",Status.B,	2014,new ArrayList<Grade>(),student22));	
		studenti.add(new Student(23,"SW 17/2015",	  "Mirko","Alicic",3,	LocalDate.parse("21.07.1999.",formatter),	l11	 , "012/1122-368","mirko.alicic@mailinator.com",Status.S,	2015,new ArrayList<Grade>(),student23));	
		studenti.add(new Student(24,"SW 17/2016",	  "Milisav","Perkoviæ",4,	LocalDate.parse("28.09.1998.",formatter),	l12	 , "012/1122-369","milisav.pejkovic@mailinator.com",Status.S,	2016,new ArrayList<Grade>(),student24));	
		studenti.add(new Student(25,"SW 27/2018",	  "Purisa","Djordjeviæ",2,	LocalDate.parse("29.02.2000.",formatter),	l3	  , "011/1543-370","purisa.djordjevic@mailinator.com",Status.B,	2018,new ArrayList<Grade>(),new ArrayList<Subject>()));	
		studenti.add(new Student(26,"RA 226/2017",	  "Mikica","Kovaceviæ",3,	LocalDate.parse("23.03.1999.",formatter),	l5	  , "011/1992-371","mikica.kovacevic@mailinator.com",Status.S,	2017,new ArrayList<Grade>(),student26));	
		studenti.add(new Student(27,"SW 12/2021",	  "Miloš","Miliæ",1,	LocalDate.parse("21.10.2001.",formatter),	l2	  , "011/8172-372","milos.milic@mailinator.com",Status.S,	2021,new ArrayList<Grade>(),new ArrayList<Subject>()));	
